...
Usage:
    ...
    python training/finetune.py --model meta-llama/Meta-Llama-3.1-8B-Instruct
    python training/finetune.py --data data/training_data.jsonl --epochs 3
    python training/finetune.py --model meta-llama/Meta-Llama-3.2-3B-Instruct  # smaller, faster on Mac
"""
