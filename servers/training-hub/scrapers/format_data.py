"""
format_data.py — Convert raw GitHub issues + docs into fine-tuning pairs.
...
Usage:
    python scrapers/format_data.py
    python scrapers/format_data.py --issues data/raw_issues.jsonl \\
